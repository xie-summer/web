<template>
    <div class="back">
        ...
        <el-row  type="flex" justify="space-between">
            <el-col :span="7" class="log_height">
                <el-col :span="14" :offset="8" style="padding-top: 12%">
                    <div class="log_d_1">
...
<style >
    ...
    .log_height{height: 16rem;margin-top:5rem; box-shadow: 5px 5px 3px #E5E5E5;background-color: #feffff}
</style>
